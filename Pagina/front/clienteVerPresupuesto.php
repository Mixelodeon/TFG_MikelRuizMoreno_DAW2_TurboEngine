...
<html lang="es">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-heading text-uppercase">Gestiona tus Presupuestos</div>
            </div>
        </header>
        ...
        <section id="gestionUsuarios" class="py-5">
            <div class="container">
            <h2 class="text-center text-uppercase mb-4">Presupuestos de <?php echo $nombre ?></h2>
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle">
                    <thead class="table-dark">
                        <tr class="text-center">
                            <th scope="col">ID_Presupuesto</th>
                    ...
                    <tbody>
                        <?php include '../back/obtener_presupuestos.php'; ?>
                    </tbody>
                </table>
            </div>
            </div>
