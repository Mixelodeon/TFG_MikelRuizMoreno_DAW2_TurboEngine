...
<html lang="es">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">¡Taller TurboEngine!</div>
                <div class="masthead-heading text-uppercase">Apartado de Citas</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="#citas">Consultar Citas</a>
            </div>
        </header>
        ...
        <!-- Citas -->
         <!-- Sección de Citas -->
<!-- Sección de Citas -->
<section id="citas" class="py-5">
    <div class="container">
        <h2 class="text-uppercase text-center mb-4">Modifica la hora de tu Cita</h2>
        <div class="d-flex justify-content-center">
            <form action="../back/mostrar_cita_a_cambiar.php" style="max-width: 600px; width: 100%;" method="POST" id="formularioCitas">
                <div class="row mb-3">
                   <div class="col-md-6">
                        <label for="hora" class="form-label">Selecciona una hora:</label>
                        <select id="hora" name="nueva_hora" class="form-select">
                ...
                <div class="text-center">
                    <br><br>
                    <button type="submit" class="btn btn-primary btn-xl">Cambiar Hora</button>
                </div>
            </form>
        </div>
    </div>
       ...
       <br><br><br>
        ...
        <script src="../js/mostrarHoras.js"></script>
    </body>
</html>
