...
<section id="citas" class="py-5">
    <div class="container">
        <h2 class="text-uppercase text-center mb-4">Gestiona tu Cita</h2>
        <div class="d-flex justify-content-center">
            <form action="../back/reservar_cita.php" style="max-width: 600px; width: 100%;" method="POST" id="formularioCitas">
                <div class="row mb-3">
                    <!-- Selección de Mes -->
                    <div class="col-md-6" id="contenedorCitasFecha">
                        <label for="fecha" class="form-label">Selecciona una fecha:</label>
                        <select id="fecha" name="fecha" class="form-select">
                            <option value="">-- Días Disponibles... --</option>
                        </select>
                    </div>
                    <div class="col-md-6" id="contenedorCitasHora">
                ...
                <div class="text-center">
                    <br><br>
                    <button type="submit" class="btn btn-primary btn-xl">Agendar Cita</button>
                </div>
            </form>
        </div>
    </div>
