document.addEventListener("DOMContentLoaded", function () {
    console.log("SweetAlert script loaded successfully");
    // Swal.fire({
    //     title: "Bienvenido"
    ...
    if (params.has("success")) {
        ...
        if (successCode === "CitaReservada") {
            // console.log("Éxito al reservar cita");
            // console.log(successCode);
            Swal.fire({
            icon: "success",
            title: "¡Éxito al reservar la cita!",
            text: "La cita ha sido reservada correctamente, puede consultar su cita en su perfil",
            confirmButtonColor: "#3085d6",
            timer: 5000,
            timerProgressBar: true,
            allowOutsideClick: true,
        ...
        if(successCode === "contraseñaActualizada"){
            consale.log("Éxito al actualizar la contraseña");
            Swal.fire({
                icon: "success",
                title: "¡Éxito al actualizar la contraseña!",
        ...
        if(successCode === "correoEnviadoCambioPassword"){
            console.log("Correo enviado para cambio de contraseña");
            Swal.fire({
                icon: "success",
                title: "¡Correo enviado!",
                text: "Se le ha enviado un correo para cambiar la contraseña, acceda a su correo y siga las instrucciones",
                confirmButtonColor: "#3085d6",
                timer: 4000,
                timerProgressBar: true,
                allowOutsideClick: true,
